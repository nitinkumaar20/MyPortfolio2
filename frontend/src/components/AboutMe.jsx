...
{/* /////////////////////////image and text /////////////////////////////////////////////////  */}
        ...
        <div className="col-md-6 text-div" >
          ...
          <motion.h3 initial="hidden" variants={variants} whileInView="visible" viewport={{once:true}} transition={{duration:.7}}   style={{fontSize:'1.6rem',lineHeight:'1rem'}}>LET’S</motion.h3>

  <motion.h1 initial="hidden" variants={variants} whileInView="visible" viewport={{once:true}} transition={{duration:.5}}  style={{fontSize:'2.1rem',lineHeight:'2rem',color:' #118868'}}>
  INTRODUCE ABOUT</motion.h1>

  <motion.h3 initial="hidden" variants={variants} whileInView="visible" viewport={{once:true}} transition={{duration:.3}}  style={{fontSize:'1.8rem',lineHeight:'1rem'}}>
  MYSELF</motion.h3>
