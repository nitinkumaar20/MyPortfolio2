...
<ul style={{fontSize:'1.1rem',display:'flex',flexDirection:'column',gap:'1rem',color:'white'}}>
...
<motion.div className='col-md-3 our-services'  initial={{ x:200}} whileInView={{x:0}}  viewport={{once:true}} transition={{duration:.5}}>
<ul style={{fontSize:'1.1rem',display:'flex',flexDirection:'column',gap:'1rem',color:'white'}}>
