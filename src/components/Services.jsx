    ...
    <section id="section-3">
      ...
      <div className="services-box">
        ...
        >
          ...
          <p>
            I provide web development services with treandy techologies like
            React, Node, Express, MongoDB, Bootstrape.
          </p>
        </motion.div>
        ...
        >
          ...
          <p>
            I provide Photoshop Editing Retouching serives for any Ecommerce and
            Personal use.
          </p>
        </motion.div>
        ...
        >
          ...
          <p>
            I provide Graphic design services for their branding and Ecommerce
            store Purspose like Amazone graphics and Banners logo Design etc.
          </p>
        </motion.div>
      </div>
    </section>
